    ...
    <div class="no-padding">
		...
		<thead>
			<tr>
                ...
                <th class="col-md-2 text-center">Collection</th>
        ...
        <?php if (!empty($paginated->items)) { ?>
            ...
            <?php foreach($paginated->items as $item) { ?>
                <tr>
                    ...
                    <?php echo date('Y-m-d g:i a', $item->{'metadata.created.time'} ); ?>
                    ...
                    <td class="text-center">
                         <?php echo $item->{'collection'}; ?>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="./admin/trash/item/delete/<?php echo $item->id; ?>">
                            <i class="fa fa-times"></i>
                        </a>
                        <a class="btn btn-xs btn-success" data-bootbox="confirm" href="./admin/trash/item/restore/<?php echo $item->id; ?>">
