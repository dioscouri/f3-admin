    ...
    <div class="no-padding">
		...
		<thead>
			<tr>
                ...
                <th data-sortable="completed.time" class="col-md-2 text-center">Completed</th>
                <th>Message</th>
            </tr>
		</thead>
		<tbody>    
        ...
        <?php if (!empty($paginated->items)) { ?>
            ...
            <?php foreach($paginated->items as $item) { ?>
                <tr>
                    ...
                    <td class="">
                        <?php echo $item->title(); ?>
                        <?php if ($item->task != $item->title()) { ?>
                            <div>Task: <?php echo $item->task; ?></div>
                        <?php } ?>
                    </td>
                    <td class="text-center">
                        <?php echo $item->{'completed.local'}; ?>
                    </td>
                    <td class="">
